 ...
 */
public class VentanaPrincipal_admVentas extends javax.swing.JFrame {
    private JPanel btn;
    /**
    ...
    public VentanaPrincipal_admVentas(String usuario) throws Exception {
        initComponents();
...
//            frm.setLocation(450, 50);
            ...
            Logger.getLogger(VentanaPrincipal_admVentas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPrincipal_admVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new VentanaPrincipal_admVentas(null).setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(VentanaPrincipal_admVentas.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
