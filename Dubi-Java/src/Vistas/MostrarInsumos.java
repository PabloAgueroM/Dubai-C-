 ...
 */
public class MostrarInsumos extends javax.swing.JDialog {
    private ArrayList<Insumo> listaInsumos;
    private Insumo Seleccion;
    public void setListaInsumos(ArrayList<Insumo> l){
        ...
        for(int i=0; i<listaInsumos.size();i++){
            fila[0] = listaInsumos.get(i).getIdInsumo();
            fila[1] = listaInsumos.get(i).getNombreInsumo();
            fila[2] = listaInsumos.get(i).getDescInsumo();
            fila[3] = listaInsumos.get(i).getStock();
            fila[4] = listaInsumos.get(i).getStockMinimo();
            modelo.addRow(fila);
        }
    }
    public Insumo getSeleccion(){
        return Seleccion;
    }
    public MostrarInsumos(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Indicacion.setText("A continuación, seleccione el insumo que desea insertar.");
        ...
        TablaInsumos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Descripcion", "Stock", "Stock Minimo"
            }
        ) {
    ...
    private void SeleccionarBotonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SeleccionarBotonMouseClicked
        ...
        if (index>=0){
        Seleccion=listaInsumos.get(index);        
        dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Debe seleccionar un insumo");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarInsumos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarInsumos dialog =new MostrarInsumos(new javax.swing.JFrame(), true);
